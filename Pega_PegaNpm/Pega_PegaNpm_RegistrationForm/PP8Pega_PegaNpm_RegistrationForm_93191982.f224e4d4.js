...
"use strict";(self.webpackChunkdxcomponent=self.webpackChunkdxcomponent||[]).push([[93191982],{127:(e,t,r)=>{r.d(t,{A:()=>a});const a="undefined"!=typeof document},150:(e,t,r)=>{r.d(t,{A:()=>x});var a=r(4848),o=r(1594),n=r(5206),i=r(832),s=r(9463),l=r(2477),c=r(4853),d=r(3351),u=r(2558),p=r(6416),_=r(393);const m=(e,t)=>{const r=e.getBoundingClientRect(),a=t.getBoundingClientRect();return{x:r.x-a.x,y:r.y-a.y}};var h=r(4680);const f=(0,o.createContext)({checkActive:()=>!0,setActive:()=>{},popovers:{}});var g=r(8889),b=r(127),y=r(6629),v=r(2365);Object.freeze({name:"sameWidth",enabled:!0,phase:"beforeWrite",fn({state:e}){e.styles.popper.width=`${e.rects.reference.width}px`},requires:["computeStyles"]});const $=b.A?(0,y.A)():0,w=(Object.freeze({name:"fitToContent",enabled:!0,phase:"beforeWrite",requires:["computeStyles","offset"],fn({state:e}){e.styles.popper.width="fit-content",e.elements.popper.style.maxWidth="60ch",e.elements.popper.style.minWidth=`${e.rects.reference.width}px`}}),Object.freeze({name:"placeAndContain",enabled:!0,phase:"beforeWrite",requires:["computeStyles","offset"],fn:({state:e})=>{const[t,r]=e.placement.split("-"),a={top:0,bottom:0,right:0,left:0},o=e.orderedModifiers.find(({name:e})=>"preventOverflow"===e)?.options?.padding;"number"==typeof o?(a.top=o,a.bottom=o,a.right=o,a.left=o):o&&(a.top=o.top??a.top,a.bottom=o.bottom??a.bottom,a.right=o.right??a.right,a.left=o.left??a.left);const n=document.documentElement.clientWidth,i=document.documentElement.clientHeight,s=e.rects.reference,l=s.x,c=l+s.width,d=s.y,u=d+s.height,p=(l+c)/2<n/2,_=(d+u)/2<i/2,m=e.modifiersData.offset?.[e.placement]?.x??0,h=e.modifiersData.offset?.[e.placement]?.y??0;let f=null,g=null;const b=[...e.elements.popper.children].flatMap(e=>{const t=e.querySelectorAll("[data-popover-scroll-el]");return t.length>0?[...t]:e}).reduce((t,r)=>r===e.elements.arrow?t:(0,v.A)(r)[0]?t+r.scrollHeight+$:t+r.scrollHeight,0),y=Math.max(e.elements.popper.scrollHeight,b),w=Math.max(e.elements.popper.scrollWidth,...Array.from(e.elements.popper.children).map(t=>t===e.elements.arrow?-1/0:(0,v.A)(t)[1]?t.scrollWidth+$:t.scrollWidth));let k=t;"bottom"===t?(g=i-u-h-a.bottom,u+h+y+a.bottom>i&&(k=_?"bottom":"top")):"top"===t?(g=d+h-a.top,d+h-y+a.top<0&&(k=_?"bottom":"top")):"left"===t?(f=l+m-a.left,l+m-w+a.left<0&&(k=p?"right":"left")):"right"===t&&(f=n-c-m-a.right,c+m+w+a.right>n&&(k=p?"right":"left")),"left"!==k&&"right"!==k||(g=i-a.top-a.bottom),e.elements.popper.style.maxHeight=`${g}px`,e.elements.popper.style.maxWidth=null!==f?`${f}px`:"",k=`${k}${r?`-${r}`:""}`,e.placement!==k&&(e.placement=k,e.reset=!0)}})),k={none:0,short:500,long:1e3},x=(0,o.forwardRef)(function({show:e=!0,portal:t=!0,target:r,placement:b="bottom",strategy:y="fixed",style:v,modifiers:$=[],arrow:x=!1,groupId:A,showDelay:C="none",hideDelay:S="none",hideOnTargetHidden:P=!1,children:T,onHide:E,onShow:z,...H},j){const{portalTarget:R}=(0,s.A)(),{checkActive:I,setActive:L,popovers:O}=(0,o.useContext)(f),[N,D]=(0,l.A)(),M=(0,c.A)(j,D),q=(0,o.useRef)(null),F=(0,o.useRef)(),U=(0,o.useRef)(null),[B,W]=(0,o.useState)(e),V=(0,o.useRef)(),G=(0,d.A)(),X=r instanceof Element?r:r?.contextElement,Y="boolean"==typeof t?R:t,Q=(0,o.useMemo)(()=>{const e=!!$.slice().reverse().find(e=>"flip"===e.name&&void 0!==e.enabled)?.enabled;return[{name:"computeStyles",options:{gpuAcceleration:!1}},{name:"offset",options:{offset:[0,x?5.5:2]}},{name:"hide",enabled:P},{name:"arrow",enabled:x,options:{element:q.current,padding:7}},{name:"preventOverflow",options:{tether:!$.find(e=>"sameWidth"===e.name||"fitToContent"),padding:16}},{...w,enabled:!e},...$]},[x,P,$]),J=(0,o.useMemo)(()=>{const e=[...Q].reverse().find(e=>"offset"===e.name&&!1!==e.enabled);return Array.isArray(e?.options?.offset)?e?.options?.offset[1]??0:0},[Q]),{styles:K,attributes:Z,forceUpdate:ee}=(0,i.E)(r,N,{placement:b,strategy:y,modifiers:Q});ee&&(F.current=ee);const[te]=(0,o.useState)(()=>new AbortController),[re]=(0,o.useState)(()=>new WeakSet),[ae]=(0,o.useState)(()=>new ResizeObserver(e=>{let t=!1;for(const{target:r}of e)re.has(r)?t||(t=!0,te.signal.aborted||F.current?.()):re.add(r)}));(0,o.useEffect)(()=>()=>{te.abort(),ae.disconnect()},[]),(0,o.useEffect)(()=>{if(N)return ae.observe(N),()=>{ae.unobserve(N)}},[N]),(0,o.useEffect)(()=>{if(X)return ae.observe(X),()=>{ae.unobserve(X)}},[X]),(0,o.useLayoutEffect)(()=>{U.current=X?m(X,document.documentElement):null},[X]),(0,o.useEffect)(()=>{if(!B||!X)return;let e;const t=()=>{if(X&&U.current){const r=m(X,document.documentElement);U.current.x!==r.x||U.current.y!==r.y?(U.current=r,F.current?.()):e=requestAnimationFrame(t)}};return e=requestAnimationFrame(t),()=>{cancelAnimationFrame(e)}},[B,X]),(0,o.useEffect)(()=>{A&&e&&L(G,A),h.A?(V.current&&clearTimeout(V.current),V.current=window.setTimeout(()=>{W(e),e&&F.current?.()},k[e?C:S])):(W(e),e&&F.current?.())},[e]),(0,o.useEffect)(()=>()=>clearTimeout(V.current),[]),(0,u.A)(()=>{B?z?.():E?.()},[B]),(0,o.useEffect)(()=>{A&&O[A]&&O[A]!==G&&W(!1)},[A?O[A]:void 0]);const oe=(0,p.A)(X,!!t),ne=(0,o.useCallback)(e=>{if(X&&t){const t=new Event(e.type.startsWith("popover:")?e.type:`popover:${e.type}`,{bubbles:!0,cancelable:!0});X.dispatchEvent(t)}},[X,t]);(0,_.A)("focusout",ne,{target:M}),(0,_.A)("popover:focusout",ne,{target:M}),(0,_.A)("focusin",ne,{target:M}),(0,_.A)("popover:focusin",ne,{target:M});const ie=(0,a.jsxs)(g.l,{...H,"data-popover-id":oe,portal:!(!t||!Y),offset:J,ref:M,style:{...v,...K.popper},...Z.popper,children:[x&&(0,a.jsx)(g.s,{ref:q,style:{...K.arrow}}),T]});return!r||!B||A&&!I(G,A)?null:t&&Y?(0,n.createPortal)(ie,Y):ie})},285:(e,t,r)=>{r.d(t,{e:()=>f,A:()=>g});var a=r(4848),o=r(1594),n=r(8267),i=r(9549),s=r(4869),l=r(1862),c=r(1649),d=r(7501),u=r(8579),p=r(2477),_=r(4853);const m=(0,r(8044).A)("backdrop",[]),h={slow:2,medium:1,fast:.5,none:0},f=(0,n.Ay)(d.A)(e=>{const{theme:{base:t}}=e,{opacity:r,alpha:a,variant:o,position:i}=e,s=`max(calc(${h[e.transitionSpeed]} * ${t.animation.speed}), 1ms)`;return n.AH`
      ...
      `}
    `});f.defaultProps=i.qn;const g=(0,s.A)((0,o.forwardRef)(function({testId:e,children:t,container:r,open:n=!1,variant:i="dark",transitionSpeed:s="medium",alpha:d=.6,position:h="fixed",onBeforeTransitionIn:g,onAfterTransitionIn:b,onBeforeTransitionOut:y,onAfterTransitionOut:v,...$},w){const k=(0,u.A)(e,m),[x,A]=(0,o.useState)("closed"),[C,S]=(0,p.A)(),P=(0,_.A)(w,S),T=(0,o.useCallback)(e=>{if("opacity"!==e.propertyName||e.target!==e.currentTarget)return;let t;"closing"===x?(t="closed",v?.()):(t="open",b?.()),A(t)},[x,v,b]);return(0,o.useEffect)(()=>{n?"closed"!==x&&"closing"!==x||(g?.(),(0,l.A)(),A("opening")):"open"!==x&&"opening"!==x||(y?.(),A("closing"))},[n]),(0,o.useEffect)(()=>{if(!P.current)return;const e=window.getComputedStyle(P.current).opacity;"closing"===x&&"0"===e&&(v?.(),A("closed")),"opening"===x&&"1"===e&&(b?.(),A("open"))},[x]),n||"closed"!==x?(0,a.jsx)(c.A,{portalTarget:C??void 0,children:(0,a.jsx)(f,{"data-testid":k.root,container:{justify:"center",alignItems:"center",...r},transitionSpeed:s,opacity:"opening"===x||"open"===x?1:0,alpha:d,variant:i,position:h,onTransitionEnd:T,ref:P,...$,children:t})}):null}),m)},393:(e,t,r)=>{r.d(t,{A:()=>n});var a=r(1594),o=r(712);const n=function(e,t,{target:r=document,eventOptions:n,dependencies:i=[]}={}){(0,a.useEffect)(()=>{const[a]=(0,o.A)([r]);if(a)return a.addEventListener(e,t,n),()=>{a.removeEventListener(e,t,n)}},[e,r,t,n,...i])}},405:(e,t,r)=>{r.d(t,{D2:()=>d,QS:()=>_,pT:()=>p,r3:()=>f,wE:()=>m,z5:()=>h});var a=r(1357),o=r(8267),n=r(7321),i=r(9549),s=r(9187),l=r(285),c=r(7501);const d=(0,o.Ay)(l.A)(()=>o.AH`
    border-radius: inherit;
  ...
  `});h.defaultProps=i.qn;const f=(0,o.Ay)(c.A)(({theme:e,placement:t})=>o.AH`
    ...
    `}
  `);f.defaultProps=i.qn},712:(e,t,r)=>{r.d(t,{A:()=>o});var a=r(8268);const o=e=>e.flatMap(e=>{if(!e)return[];const t=(0,a.A)(e,EventTarget)?e:e.current;return t?[t]:[]})},1093:(e,t,r)=>{r.d(t,{A:()=>n});var a=r(4848),o=r(1649);const n=e=>t=>(0,a.jsx)(o.A,{children:(0,a.jsx)(e,{...t})})},1649:(e,t,r)=>{r.d(t,{Q:()=>C,A:()=>z});var a=r(4848),o=r(1594),n=r(5206),i=r(8267),s=(r(8347),r(1357)),l=r(7321);const c=i.AH`
  *,
  *::before,
  *::after {
...
`,d=(0,i.DU)(({theme:e})=>{const{base:{"custom-scrollbar":t,palette:{"foreground-color":r},shadow:{focus:a},transparency:{"transparent-3":o}},components:{"form-control":{"background-color":n}}}=e;return i.AH`
  ...
  `},v=(e,t)=>({contrastColor:t?e:(0,l.A)(()=>(0,d.W0)(e)),hoverColors:(0,d.ZV)(t||e),activeColors:(0,d.BI)(t||e)}),$=(e,t)=>{const r=(0,d.VR)(t)?t:(0,d.W0)(e),a=(0,l.A)(()=>(0,i.IM)(e,r).AA),o=a?e:(0,d.ho)(e,t),n=(0,l.A)(()=>(0,i.jh)(.9,t,e)),s=(0,l.A)(()=>(0,i.jh)(.8,t,o));return{textColor:a?e:(0,d.W0)(e),hoverBg:n,hoverFg:(0,d.ho)(e,n??"transparent"),activeBg:(0,l.A)(()=>(0,i.jh)(.8,t,o)),activeFg:(0,d.ho)(o,s??"transparent")}},w=n.Ay.button.withConfig((0,d.ks)("loading"))(({variant:e,icon:t,loading:r,compact:a,theme:o})=>{const{base:{spacing:i,"border-radius":s,palette:{"primary-background":l},"hit-area":{"mouse-min":c,"finger-min":d,"compact-min":u},animation:{speed:p}},components:{button:{color:_,"foreground-color":h,"secondary-color":g,"secondary-fill-style":b,padding:w,"border-radius":k,"border-width":x,touch:{padding:A}}}}=o,C=y(o),S=n.AH`
    ...
    `,{contrastColor:P,hoverColors:T,activeColors:E}="primary"!==e||"auto"===h?v("primary"===e?_:g):v(h,_),z=n.AH`
    ...
    `;return n.AH`
      ${C}
      ${S}
        ${("primary"===e||"secondary"===e&&"fill"===b)&&z}
        ${"secondary"===e&&"outline"===b&&j}
        ${"simple"===e&&I}
        ${"primary"===e&&n.AH`
  ...
  `;return n.AH`
    ...
    ${_}
      ${"link"===t&&m}
      ${"text"===t&&h}
  `});k.defaultProps=s.qn;const x=(0,o.forwardRef)(function({variant:e="secondary",type:t="button",disabled:r=!1,icon:n=!1,compact:i=!1,href:s,as:l,forwardedAs:d,label:m,"aria-label":f,loading:g=!1,children:b,className:y,...v},$){const[x,A]=(0,u.A)(),C=(0,o.useRef)(),S=(0,o.useRef)(),P=(0,o.useRef)(),T=(0,p.A)($,A),E=["link","text"].includes(e),z=g&&!E,H=E?k:w,j=e=>{T.current&&S.current&&P.current&&(({x:e,y:t},r)=>e>=r.left&&e<=r.right&&t>=r.top&&t<=r.bottom)({x:e.clientX,y:e.clientY},S.current)&&Date.now()-P.current<500&&T.current.click()};return(0,o.useEffect)(()=>(document.addEventListener("mouseup",j),()=>{document.removeEventListener("mouseup",j),C.current=void 0,S.current=void 0,P.current=void 0}),[]),(0,a.jsxs)(a.Fragment,{children:[(0,a.jsxs)(H,{...v,ref:T,as:l||(s?"a":"button"),forwardedAs:d||(s?"a":"button"),className:(0,c.A)("button",y,{variant:e,icon:n,compact:i,loading:g}),variant:e,icon:n,compact:i,type:s?void 0:t,href:s,disabled:r&&!s,loading:z,"aria-label":f||m,onMouseDown:e=>{v.onMouseDown?.(e),e.persist(),C.current=e,S.current=e.currentTarget.getBoundingClientRect(),P.current=Date.now()},onMouseUp:e=>{const t=C.current&&!C.current.defaultPrevented;return C.current=void 0,S.current=void 0,P.current=void 0,t&&T.current!==document.activeElement&&T.current?.focus(),v.onMouseUp?.(e)},children:[z&&(0,a.jsx)(h.A,{variant:"ring",placement:"inline"}),n&&z?null:b]}),x&&m&&(0,a.jsx)(_.A,{target:x,showDelay:"none",hideDelay:"none",describeTarget:!1,children:m})]})})},6883:(e,t,r)=>{r.d(t,{A:()=>p,e:()=>u});var a=r(4848),o=r(1594),n=r(8267),i=r(9549);const s=e=>["between","around","evenly"].includes(e)?`space-${e}`:e,l=e=>{if(!e)return;if(!0===e)return n.AH`
      display: grid;
