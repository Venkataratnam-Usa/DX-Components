...
import StyledPegaPegaNpmSampleTestInputWrapper from './styles';

// interface for props
interface PegaPegaNpmSampleTestInputProps extends PConnFieldProps {
...
function PegaPegaNpmSampleTestInput(props: PegaPegaNpmSampleTestInputProps) {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledPegaPegaNpmSampleTestInputWrapper> {displayComp} </StyledPegaPegaNpmSampleTestInputWrapper>
    ) : (
      <StyledPegaPegaNpmSampleTestInputWrapper>
        <FieldValueList
...
export default withConfiguration(PegaPegaNpmSampleTestInput);
